...
This project is indexed by GitNexus as **cometode** (324 symbols, 499 relationships, 17 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
