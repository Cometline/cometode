...
This project is indexed by GitNexus as **cometode** (317 symbols, 481 relationships, 15 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
